...
public:
	Camera();
	Camera(glm::vec3 initialPosition, glm::vec3 initialUpDirection, GLfloat initialYaw, GLfloat initialPitch, GLfloat initialMovementSpeed, GLfloat initialTurnSpeed);
